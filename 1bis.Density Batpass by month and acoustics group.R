...
####### load different acoustic group ######### -----

Hippo_mb <- read.csv(file = "~/Downloads/Hippo_mb.csv", header = T, sep = ",")
Minio_Allac_mb <- read.csv(file ="~/Downloads/Minio_Allac_mb.csv", header = T, sep = ",")
Rhino_la_Allac_mb <- read.csv(file = "~/Downloads/Rhino_la_Allac_mb.csv", header = T, sep = ",")
Rhino_de_Allac_mb <-  read.csv(file = "~/Downloads/Rhino_de_Allac_mb.csv", header = T, sep = ",")
Hippo_bd <-  read.csv(file ="~/Downloads/Hippo_bd.csv", header = T, sep = ",")
Rhino_macro_tria_all <- read.csv(file = "~/Downloads/Rhino_macro_tria_all.csv", header = T, sep = ",")
Minio_Allac_bd <- read.csv(file = "~/Downloads/Minio_Allac_bd.csv", header = T, sep = ",")
Rhino_de_Allac_bd <- read.csv(file = "~/Downloads/Rhino_de_Allac_bd.csv", header = T, sep = ",")
